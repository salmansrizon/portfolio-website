...
const RoadmapManager = () => {
  const { items: roadmaps, pageItems, pagination, isLoading: loading, openCreate, openEdit, remove, dialog } = useEntityManager(roadmapConfig);
    ...
    <div className="space-y-4">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-xs text-muted-foreground">Manage career roadmaps with markdown content</p>
        </div>
            ...
            <CardContent className="flex items-center justify-between p-4">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="line-clamp-2 text-xs text-muted-foreground">{r.description || 'No description'}</p>
                </div>
      ...
      <ListPager pagination={pagination} label="roadmaps" />
