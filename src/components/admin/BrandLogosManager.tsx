...
const BrandLogosManager = () => {
  const { items: logos, pageItems, pagination, isLoading: loading, openCreate, openEdit, remove, dialog } = useEntityManager(brandLogoConfig);
  ...
  return (
    <div className="space-y-4">
      ...
      <ListPager pagination={pagination} label="logos" />
