    ...
    <div className="min-h-screen flex items-center justify-center bg-background px-4">
      ...
      >
        ...
        <div className="relative mb-8">
          <h1 className="text-8xl md:text-9xl font-black text-accent">
            404
          </h1>
        </div>
        ...
        <div className="mb-8 space-y-4">
          ...
          <div className="bg-secondary rounded-2xl p-4 border border-border inline-block">
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
          <a
            href="/"
            className="group inline-flex items-center gap-2 bg-primary hover:bg-primary-hover text-primary-foreground px-6 py-3 rounded-full font-semibold transition-all duration-200 hover:scale-105"
          >
          ...
          <button
            ...
            className="group inline-flex items-center gap-2 bg-muted hover:bg-muted/70 text-foreground px-6 py-3 rounded-full font-semibold transition-all duration-200 hover:scale-105"
          >
